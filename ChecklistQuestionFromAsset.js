...
//                settings.AlertType = Converter.byte(question[j].Action);
                settings.AlertType = question[j].Action;
...
//                settings.QuestionNo = Converter.Short(question[j].UniqueID);
                settings.QuestionNo = question[j].UniqueID;
                ...
                settings.CmdNo = question[j].UniqueID
...
function getBytes(data) {
    ...
    let byte_sequence = Converter.byte(data.Sequence);

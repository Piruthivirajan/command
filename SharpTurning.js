        ...
        try {
            ...
            for (let i = 0; i < data.length; i++) {
                    ...
                    data[i].System == 2))
               {
                ...
                var settings = {};
                settings.MinimumSharpTurns = data[i].MinimumSharpTurns
...
function getBytes(data) {
    ...
    let MinimumSharpTurnsbytes = Converter.byte(data.MinimumSharpTurns);
    bytearray = Buffer.concat([bytearray, MinimumSharpTurnsbytes]);

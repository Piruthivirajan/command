	...
	main: async function (data, userID,PrevisousData) {
		try {
			...
			for (let i = 0; i < data.length; i++) {
					...
					settings.MinutesToComplete = data[i].MISCSettingsJson["cmd_1105"]["MinutesToComplete"]
					if (PrevisousData != null && PrevisousData.MISCSettingsJson["cmd_1105"]["MinutesToComplete"] == data[i].MISCSettingsJson["cmd_1105"]["MinutesToComplete"]) {
...
function getBytes(data) {
	...
	let MinutesToComplete =  Converter.byte(data.MinutesToComplete)
	byte_array = Buffer.concat([byte_array,MinutesToComplete]);
